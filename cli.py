...
Examples:
  ...
  Export to CSV:
    python cli.py export --output fuel_data.csv                    # Export all data
    python cli.py export --output 2024.csv --start-date 2024-01-01 # Filter by date
    python cli.py export --output site_123.csv --site-id 123       # Specific site
    python cli.py export --output unl.csv --grade UNL              # Specific grade
  ...
  Run backtest:
    ...
    export_parser.add_argument(
        ...
        help="Output CSV file path (default: fuel_sales_export.csv)",
    )
    export_parser.add_argument(
